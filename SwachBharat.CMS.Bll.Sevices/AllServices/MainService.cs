...
public int GetUserAppId(string UserId)
        ...
        public int GetUserAppIdL(string UserId)
        {
            ...
            AppId = dbMain.AD_USER_MST_LIQUID.Where(x => x.APP_ID == AppId1 && x.APP_ID == 3109).Select(x => x.APP_ID).FirstOrDefault();
        ...
        public int GetUserAppIdSS(string UserId)
        {
            ...
            int AppId1 = 0;
            AppId1 = Convert.ToInt32(UserId);
            AppId = dbMain.AD_USER_MST_STREET.Where(x => x.APP_ID == AppId1 && x.APP_ID == 3109 ).Select(x => x.APP_ID).FirstOrDefault();
